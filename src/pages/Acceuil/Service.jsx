        ...
        {services.map((service, index) => (
          <Dialog.Root key={index}>
            <Dialog.Trigger asChild>
              <div className="service-card" tabIndex={0} aria-label={`Voir plus sur ${service.title}`}>
            ...
            <Dialog.Portal>
              ...
              <Dialog.Content className="modal-content" aria-describedby={`desc-${index}`}>
                ...
                />
                <Dialog.Description id={`desc-${index}`} style={{ marginTop: "1rem" }}>
                  {service.description}
                </Dialog.Description>
